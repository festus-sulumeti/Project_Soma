...
import { columns as teacherCols } from "@/tables/teachers/columns";
...
export function TeacherAccounts() {
  ...
  const [renderedData, setRenderedData] = useState([...teachers]);
        ...
        <Button
          ...
          onClick={() => {
            ...
            setTimeout(() => {
              refetchTeachers();
              setIsFetching(false);
              toast.success("Teacher list updated successfully");
            }, 1500);
          }}
        >
      ...
      <div className="flex items-center py-4 mx-8 justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Dialog>
            ...
            <DialogContent>
              <TeacherAccountForm refetch={refetchTeachers} />
            </DialogContent>
          </Dialog>
        </div>
      </div>
